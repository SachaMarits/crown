/**
 * Mapping des titres des champions League of Legends
 * Format: "The [Title]" ou "[Title]"
 */
export const championTitles: Record<string, string> = {
  ...
  "Yunara": "the Unforgotten",
  "Yuumi": "the Magical Cat",
  "Zaahen": "the Unforgotten",
  ...
  "Ambessa": "the Unforgotten",
};

/**
 * Obtenir le titre d'un champion
 */
export function getChampionTitle(championName: string): string {
  return championTitles[championName] || "";
}